...
<form method="post" class="form-horizontal">
	<div class="form-group">
	    ...
	    <div class="col-sm-4">
	      <input class="form-control" name="blogTitle" id="blogTitle" placeholder="博客标题" value="${blog.blogTitle}">
	    </div>
	  </div>
    ...
    <div class="form-group">
     <label class="col-sm-4 control-label">文章内容（请使用MarkDown语法）</label>
              ...
              <input type="file" name="myfiles" id="myBlogImage" class="col-sm-5 col-sm-push-1 ">
                ...
                <div class="form-group">
                <textarea class="form-control col-sm-8 col-sm-push-1" rows="10" id="markdownContent" name="markdownContent" >${blog.markdownContent}</textarea>
                </div>
